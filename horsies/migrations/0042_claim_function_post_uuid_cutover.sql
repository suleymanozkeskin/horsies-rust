-- Append-only post-cutover replacement for horsies_claim. Migration 0027 stays
-- byte-stable for databases that already applied it. The v35 UUID task identity
-- requires the Python v12 text-facing OUT contract to cast the stored UUID.
--
-- The Python implementation's schema v12: OUT columns become exactly
